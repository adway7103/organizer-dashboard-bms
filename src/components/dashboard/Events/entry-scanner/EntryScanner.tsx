  ...
  const columns: ColumnDef<EntryScanner>[] = [
    {
      ...
      header: "Token ID",
      cell: ({ row }) => (
        <div className="text-black">{row.getValue("tokenId")}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      header: "Description",
      cell: ({ row }) => (
        <div className="text-black">{row.getValue("description")}</div>
      ),
    },
    {
      accessorKey: "status",
      header: "Status",
      cell: ({ row }) => (
        <div className="bg-[#d4fdd3] text-center rounded-full py-1 text-black">
          {row.getValue("status")}
        </div>
      ),
    },
